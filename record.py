...
def select_info_for_manifold(args):
    ...
    switch_goal_infos = cal_plot.select_switch_start_goal_infos(args.n_agents, hippos[1], theta_fasts[1], \
...
def loading_record_info(args):
    ...
    # print(phases[0][:10])
    return hist_state, hippos, theta_fasts, theta_slows, hipp_infos, trajs, phases
